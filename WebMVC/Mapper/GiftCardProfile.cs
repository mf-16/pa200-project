...
public class GiftCardProfile : Profile
{
    ...
    public GiftCardProfile()
    {
        ...
        CreateMap<CreateGiftCardViewModel, CreateGiftCardDto>()
            ...
            .ForMember(dest => dest.ValidFrom, opt => opt.MapFrom(src => src.ValidFrom.ToUniversalTime()))
            .ForMember(dest => dest.ValidTo, opt => opt.MapFrom(src => src.ValidTo.ToUniversalTime()));
